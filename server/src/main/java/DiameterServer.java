...
import dictionary.AvpDictionary;
import dictionary.AvpRepresentation;
...
public class DiameterServer implements NetworkReqListener {
    ...
    private static final String dictionaryFile = "org.example/server/dictionary.xml";
    ...
    private void initStack() {
        ...
        try {
            ...
            isf.registerAppFacory(ServerS6aSession.class, new S6aSessionFactoryImpl(factory));
